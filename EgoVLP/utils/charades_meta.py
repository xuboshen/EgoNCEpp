...
metadata_dir = "/fs/fast/base_path/data/CharadesEgo/"
split_files = {
...
path_metadata = "/fs/fast/base_path/data/CharadesEgo/metadata_" + split + ".csv"
...
mapping = pd.read_csv(
    "/fs/fast/base_path/data/CharadesEgo/Charades_v1_classes.txt", header=None
)
