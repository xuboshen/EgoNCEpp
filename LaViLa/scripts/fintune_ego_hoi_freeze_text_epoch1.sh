python -m torch.distributed.launch \
    ...
    --output-dir /fs/fast/base_path/code/LaViLa/output/frozen_charades \
    --pretrain-model /fs/fast/base_path/code/LaViLa/pretrained/clip_openai_timesformer_base.narrator_rephraser.ep_0001.md5sum_02dbb9.pth \
    --use-checkpoint \
    --eval-freq 1 \
    --save-freq 1 \
    --batch-size 64 \
