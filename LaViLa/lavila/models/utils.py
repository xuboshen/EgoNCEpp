...
def inflate_positional_embeds(
    ...
    elif 'visual.base_model.model.temporal_embed' in new_state_dict and 'visual.base_model.model.temporal_embed' in curr_keys:
        ...
        if load_num_frames != curr_num_frames:
            if load_num_frames > curr_num_frames:
                ...
                if load_temporal_fix == 'zeros':
                    ...
                    raise NotImplementedError
            new_state_dict['visual.base_model.model.temporal_embed'] = new_temporal_embed
    ...
    elif 'visual.base_model.model.pos_embed' in new_state_dict and 'visual.base_model.model.pos_embed' in curr_keys:
