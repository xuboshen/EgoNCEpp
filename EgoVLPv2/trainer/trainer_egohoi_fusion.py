...
class Multi_Trainer_dist_hoi_fusion(Multi_BaseTrainer_dist):
    """
    Trainer class
    ...
    def _valid_epoch(self, epoch, gpu):
        ...
        v_pred_arr_vtm = {x: [] for x in range(len(self.valid_data_loader))}
        n_pred_arr_vtm = {x: [] for x in range(len(self.valid_data_loader))}

        v_pred_arr_ensemble = {x: [] for x in range(len(self.valid_data_loader))}
        n_pred_arr_ensemble = {x: [] for x in range(len(self.valid_data_loader))}
