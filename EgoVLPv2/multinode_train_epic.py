...
parser.add_argument(
    "--task_names", default="EgoNCE_ITM_MLM", type=str, help="Task_Names"
)
parser.add_argument(
    "-c",
    "--config",
    default="/fs/fast/base_path/code/EgoVLPv2/EgoVLPv2/configs/eval/epic.json",
    type=str,
...
parser.add_argument(
    "-l", "--launcher", choices=["none", "pytorch"], default="none", help="job launcher"
)
parser.add_argument("-lr1", "--learning_rate1", type=float, default=2e-4)
parser.add_argument("-sc", "--schedule", default=[60, 80])
parser.add_argument(
    "--print_freq", type=int, default=100, help="print loss after this number of steps"
)
