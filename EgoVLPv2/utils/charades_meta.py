...
metadata_dir = (
    "/cis/home/shraman/works_meta_2022/Datasets/CharadesEgo_v1_480/CharadesEgo/"
)
split_files = {
...
path_metadata = (
    "/cis/home/shraman/works_meta_2022/Datasets/CharadesEgo_v1_480/CharadesEgo/metadata_"
    + split
    + ".csv"
)
csv_metadata = open(path_metadata, "w")

metadata_reader = csv.writer(
    csv_metadata,
    delimiter="¥",
    lineterminator="\n",
...
mapping = pd.read_csv(
    "/cis/home/shraman/works_meta_2022/Datasets/CharadesEgo_v1_480/CharadesEgo/Charades_v1_classes.txt",
    header=None,
)
