...
def egohoi_accuracy_metrics(v_preds, n_preds):
    try:
        print(v_preds.shape)
        metrics = {}
...
def mir_metrics_vtc(similarity_matrix, idx_arr):
    ...
    path_dataframes = "/fs/fast/base_path/data/EK100_256p/epic-kitchens-100-annotations/retrieval_annotations"
    ...
    path_relevancy = "/fs/fast/base_path/data/EK100_256p/epic-kitchens-100-annotations/retrieval_annotations/relevancy/caption_relevancy_EPIC_100_retrieval_test.pkl"
