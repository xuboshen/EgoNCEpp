...
class FrozenInTime(BaseModel):
    def __init__(self,
        ...
        if self.text_params['model'].startswith('roberta'):
            self.text_model = RobertaModel.from_pretrained("/fs/fast/base_path/code/EgoVLPv2/pretrained/roberta-base")
...
class EgoVLP_lora(FrozenInTime):
    def __init__(self,
        ...
        super().__init__(video_params, text_params, projection_dim, 
            load_checkpoint, projection, load_temporal_fix, config, task_names, norm_layer, embed_dim)
